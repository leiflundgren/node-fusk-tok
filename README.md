...
Node.js and typescript to download web comic Two Kinds
...
[project-url]: https://github.com/leiflundgren/node-fusk-tok
[package-image]: https://badge.fury.io/js/typescript-template.svg
[package-url]: https://badge.fury.io/js/typescript-template
[issues-image]: https://img.shields.io/github/issues/leiflundgren/node-fusk-tok.svg?style=popout
[issues-url]: https://github.com/leiflundgren/node-fusk-tok/issues
[build-image]: https://travis-ci.org/leiflundgren/node-fusk-tok.svg?branch=master
[build-url]: https://travis-ci.org/leiflundgren/node-fusk-tok
[coverage-image]: https://coveralls.io/repos/github/leiflundgren/node-fusk-tok/badge.svg?branch=master
[coverage-url]: https://coveralls.io/github/leiflundgren/node-fusk-tok?branch=master
[dependencies-image]: https://david-dm.org/leiflundgren/node-fusk-tok/status.svg
[dependencies-url]: https://david-dm.org/leiflundgren/node-fusk-tok
[dev-dependencies-image]: https://david-dm.org/leiflundgren/node-fusk-tok/dev-status.svg
[dev-dependencies-url]: https://david-dm.org/leiflundgren/node-fusk-tok?type=dev
